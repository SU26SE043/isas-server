...
namespace Isas.InterviewService.Migrations
{
    ...
    [Migration("20260916112513_AddPromptTemplateUpdatedByEmail")]
    partial class AddPromptTemplateUpdatedByEmail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Isas.InterviewService.Entities.PracticeFocusEvent", b =>
                {
                    ...
                    b.ToTable("practice_focus_events", null, t =>
                        {
                            t.HasCheckConstraint("ck_practice_focus_events_signal_type", "signal_type IN ('tab_switch', 'paste', 'focus_lost')");
                        });
                });
