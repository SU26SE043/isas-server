...
namespace Isas.InterviewService.Migrations
{
    ...
    [Migration("20260917113320_AddPracticeFaceCheckB2c")]
    partial class AddPracticeFaceCheckB2c
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Isas.InterviewService.Entities.PracticeFaceImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_practice_face_images");

                    b.HasIndex("CapturedAt")
                        .HasDatabaseName("ix_practice_face_images_captured_at");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("ix_practice_face_images_session_id");

                    b.HasIndex("StorageKey")
                        .IsUnique()
                        .HasDatabaseName("ix_practice_face_images_storage_key");

                    b.ToTable("practice_face_images", (string)null);
                });

            modelBuilder.Entity("Isas.InterviewService.Entities.PracticeFocusEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_practice_focus_events");

                    b.HasIndex("SessionId", "SignalType")
                        .HasDatabaseName("ix_practice_focus_events_session_id_signal_type");

                    b.ToTable("practice_focus_events", null, t =>
                        {
                            t.HasCheckConstraint("ck_practice_focus_events_signal_type", "signal_type IN ('tab_switch', 'paste', 'focus_lost', 'no_face', 'multiple_faces')");
                        });
                });
            ...
            modelBuilder.Entity("Isas.InterviewService.Entities.PracticeSession", b =>
                {
                    ...
                    b.Property<bool>("FocusTrackingEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("focus_tracking_enabled");
            ...
            modelBuilder.Entity("Isas.InterviewService.Entities.PracticeFocusEvent", b =>
                {
                    b.HasOne("Isas.InterviewService.Entities.PracticeSession", "Session")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_practice_focus_events_practice_sessions_session_id");
