...
public class CampaignInviteShortlistTests
{
    ...
    public async Task Analyzed_co_email_tao_invitation_gan_candidateId_va_Invited()
    {
        ...
        var result = await svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { c1.Id, c2.Id }, default);
    ...
    public async Task Email_null_vao_failed_status_khong_doi()
    {
        ...
        var result = await svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { withEmail.Id, noEmail.Id }, default);
    ...
    public async Task Da_Invited_skip_khong_tao_invitation_moi()
    {
        ...
        var publisher = new Mock<IInvitationEmailPublisher>();
        var svc = NewService(tdb.NewContext(), publisher.Object);
        var result = await svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { invited.Id }, default);
    ...
    public async Task Chua_Analyzed_vao_failed()
    {
        ...
        var svc = NewService(tdb.NewContext());
        var result = await svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { filtered.Id }, default);
    ...
    public async Task Campaign_chua_Active_nem_InvalidOperationException()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { cand.Id }, default));
    }
    ...
    public async Task Ngoai_org_nem_KeyNotFound()
    {
        ...
        await Assert.ThrowsAsync<KeyNotFoundException>(() =>
            svc.InviteShortlistedCandidatesAsync(Guid.NewGuid() /* org khác */, camp.Id, new() { cand.Id }, default));
    }
    ...
    public async Task Vuot_max_candidates_nem_ArgumentException_khong_tao()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { c1.Id, c2.Id }, default));
    ...
    public async Task Email_da_moi_duong1_vao_failed_dedup()
    {
        ...
        var svc = NewService(tdb.NewContext());
        var result = await svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { cand.Id }, default);
    ...
    public async Task CandidateId_ngoai_campaign_vao_failed()
    {
        ...
        var result = await svc.InviteShortlistedCandidatesAsync(owner, camp.Id, new() { ghost }, default);
