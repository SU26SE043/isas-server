...
namespace Isas.CampaignService.Services
{
    ...
    /// <summary>
    /// AI soạn mốc điểm cho tiêu chí campaign (CAMP-16).
    ///
    /// <para><b>KHÔNG fallback dải mặc định</b> — khác hẳn <see cref="AiServiceCriteriaSuggester"/>.
    /// Fallback ở đây nghĩa là HR mở màn hình lên, thấy "Mức 3: Mức 3/10" và tin rằng AI đã soạn nó;
    /// rồi publish một thước đo chưa ai viết. "Chưa có mốc" là trạng thái HỢP LỆ (Interview dùng dải
    /// mặc định như trước tính năng này) nên fail-loud không chặn ai làm việc.</para>
    ///
    /// <para>Nhân nhượng cho lỗi chớp nhoáng: thử lại ĐÚNG một lần rồi mới 502.</para>
    /// </summary>
