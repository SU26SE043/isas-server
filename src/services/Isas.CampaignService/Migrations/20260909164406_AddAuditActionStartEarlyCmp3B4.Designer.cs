...
namespace Isas.CampaignService.Migrations
{
    ...
    [Migration("20260909164406_AddAuditActionStartEarlyCmp3B4")]
    partial class AddAuditActionStartEarlyCmp3B4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Isas.CampaignService.Models.AuditLog", b =>
                {
                    ...
                    b.ToTable("audit_logs", null, t =>
                        {
                            t.HasCheckConstraint("ck_audit_logs_action", "action IN ('CreateCampaign', 'EditQuestions', 'EditCriteria', 'Publish', 'Delete', 'TransitionStatus', 'Invite', 'ScreenCandidates', 'EditCandidate', 'ReissueInvitation', 'OverrideResult', 'CreateApiKey', 'RevokeApiKey', 'ApplyScoringPolicy', 'StartEarly')");
                        });
                });
