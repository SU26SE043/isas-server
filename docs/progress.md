...
> ✅ V1: **E2,D1,P1,BC6**. ✅ V2: **P7,E3,E4,BC13**. ✅ V3: **P4,C11,E8**. ✅ V4: **P5,C12,BC11**. ✅ V5: **P6,E5,BC9**. ✅ V6: **P8a,E6,BC7**. ✅ V7: **E7,C13,BC2**. ✅ V8: **C14,BC8,BK7**. ✅ V9: **BK11,BK1,BK12**. ✅ V10: **P2,C15,BC12**. ✅ V11: **BC14,BK4,BC10-AI**. ✅ V12: **D2**. ✅ V13: **BC10(full),P3,D3**. ✅ V14: **BC15,D4,P8b**. ✅ V15: **I2,A4** (xem bảng trên). Frontier mới bên dưới.
...
1. **D2 ✅ · D3 ✅ · D4 ✅ (aa87ee7)** — membership model + resume regression + reissue invitation. **Gỡ chặn HTTP entry B2B.** → còn **BK14** (reserve-on-start + retake ratify), **BK16** (verify resume Interview-side). **E2E B2B thật** (compose + broker: join→start→làm bài→chấm→ranking→my-campaigns Completed) = verify tay ngoài worker.
2. **P2 ✅ · P3 ✅ · P8b ✅ · A4 ✅ (3608959)** — engine tiền đủ: mua pack (P2) · active-polling (P3) · invoice postpaid (P8b) · HrMember→403 billing (A4). **Còn verify tay:** PayOS sandbox thật (payment-link + webhook HMAC) ngoài worker → xong mới coi luồng tiền E2E-Xong; mở khoá **BC1** (mua pack ví User). **BK17** (P8b follow-ups).
...
5. **I2 ✅ (443e831)** — per-question time-limit + `session.deadline` + sweeper auto-submit/abandon (gỡ design gap E3). → còn **BK18** (Campaign gửi `expires_at` để B2B có Deadline thật) + lesson B2C release-credit-treo (Deadline=null).
