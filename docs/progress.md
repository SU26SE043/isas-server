...
> ✅ V1: **E2,D1,P1,BC6**. ✅ V2: **P7,E3,E4,BC13**. ✅ V3: **P4,C11,E8**. ✅ V4: **P5,C12,BC11**. ✅ V5: **P6,E5,BC9**. ✅ V6: **P8a,E6,BC7**. ✅ V7: **E7,C13,BC2**. ✅ V8: **C14,BC8,BK7**. ✅ V9: **BK11,BK1,BK12**. ✅ V10: **P2,C15,BC12**. ✅ V11: **BC14,BK4,BC10-AI**. ✅ V12: **D2**. ✅ V13: **BC10(full),P3,D3**. ✅ V14: **BC15,D4,P8b** (xem bảng trên). Frontier mới bên dưới.
...
2. **P2 ✅ · P3 ✅ · P8b ✅ (56a78cc)** — engine tiền đủ: mua pack (P2) · active-polling (P3) · invoice postpaid (P8b). **Còn verify tay:** PayOS sandbox thật (payment-link + webhook HMAC) ngoài worker → xong mới coi luồng tiền E2E-Xong; mở khoá **BC1** (mua pack ví User), **A4** (HrMember→403 billing). **BK17** (P8b follow-ups: Overdue-block reserve · close subtract-snapshot).
