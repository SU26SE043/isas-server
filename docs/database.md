...
> | `isas_interview` | Interview (engine B2C+B2B) | [services/interview.md](services/interview.md) — **14 bảng** |
> | `isas_campaign` | Campaign (B2B) | [services/campaign.md](services/campaign.md) — **10 bảng** |
> | `isas_payment` | Payment (credit/PayOS) | [services/payment.md](services/payment.md) — **9 bảng** |
>
