...
> **Trạng thái:** **B2C** — engine luyện tập + lịch sử **đã chạy**, còn thiếu ví credit cá nhân (D15). **B2B** — tái dùng engine này + thêm lớp điều phối (campaign, distribution, ranking, result), **phần lớn chưa build**. Thanh toán (credit/PayOS) dùng chung. Phạm vi đầy đủ & phân công xem [work-division.md](work-division.md).
